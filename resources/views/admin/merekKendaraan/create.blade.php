            ...
            <div class="col-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" action="{{route('merekKendaraan.store')}}">
                            @csrf
                            <div class="form-group">
                                <label for="exampleInputName1">Jenis Kendaraan</label>
                                <input type="text" name="merek_kendaraan" class="form-control" id="exampleInputName1" placeholder="Hanya Angka ex: Honda">
                            </div>
