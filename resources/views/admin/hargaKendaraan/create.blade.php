            ...
            <div class="col-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" action="{{route('hargaKendaraan.store')}}">
                            @csrf
                            <div class="form-group">
                                ...
                                <select name="id_merek_kendaraan" id="id_merek_kendaraan" class="form-control">
                                    ...
                                    @foreach ($merkKendaraan as $item)
                                        <option value="{{$item->id}}" {{old('id_merek_kendaraan') == $item->id ? 'selected' : ''}}>
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_tipe_kendaraan" id="id_tipe_kendaraan" class="form-control">
                                    ...
                                    @foreach ($tipeKendaraan as $item)
                                        <option value="{{$item->id}}" {{old('id_tipe_kendaraan') == $item->id ? 'selected' : ''}}>
                                            {{$item->tipe_kendaraan}}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_jns_kendaraan" id="id_jns_kendaraan" class="form-control">
                                    ...
                                    @foreach ($jnsKendaraan as $item)
                                        <option value="{{$item->id}}" {{old('id_jns_kendaraan') == $item->id ? 'selected' : ''}}>
                                            {{$item->jns_kendaraan}}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_tahun_kendaraan" id="id_tahun_kendaraan" class="form-control">
                                    ...
                                    @foreach ($thnKendaraan as $item)
                                        <option value="{{$item->id}}" {{old('id_tahun_kendaraan') == $item->id ? 'selected' : ''}}>
                                            {{$item->tahun_kendaran}}
                                        </option>
                                    @endforeach
                                </select>
