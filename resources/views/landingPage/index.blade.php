...
<body class="bg-white text-gray-800">
    ...
    <main class="font-serif mt-10 max-w-4xl px-4 mx-auto">
        ...
        <img src="{{ asset('landing_page/code_wallpapper.png')}}" alt="gambar ADIRA Alam Sutera"
        ...
        <div class="text-center">
            <button class="bg-yellow-300 rounded-full py-2 px-6 mb-6 font-semibold hover:bg-yellow-500  transition duration-300">
                KLIK DISINI
            </button>
        </div>
        ...
        <ul class="list-disc space-y-4 px-4">
            <li class="font-bold">Berijin dan diawasi oleh otoritas</li>
            <p>Lorem ipsum dolor sit amet...</p>

            <li class="font-bold">Tenor Variatif mulai 1 sampai 6 tahun</li>
            <p>Lorem ipsum dolor sit amet...</p>

            <li class="font-bold">Proses dan Persyaratan Mudah</li>
            <p>Lorem ipsum dolor sit amet...</p>

            <li class="font-bold">Pembayaran mudah dan efisien</li>
            <p>Lorem ipsum dolor sit amet...</p>
        </ul>

        <div class="text-center mt-6 mb-10">
            <button class="bg-green-300 rounded-full py-2 px-6 font-semibold flex content-center mx-auto gap-3 hover:bg-green-500 transition duration-300">
        ...
        <h3 class="font-bold text-base text-center mb-4">
            Proses Dana Tunai Jaminan BPKB Mobil dan Motor di Adira Finance Alam Sutera
        </h3>

        <!-- Image Sections -->
        <div class="grid md:grid-cols-3 gap-6">
            <div class="text-center">
                <img src="{{ asset('landing_page/code_wallpapper.png')}}" alt="" class="w-40 mx-auto mb-2" />
